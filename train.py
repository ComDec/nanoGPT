...
if config["use_flash"] == 1:
    pbar = tqdm(range(max_iters), maxinterval=max_iters, desc="Training with Flash Attention")
else:
    pbar = tqdm(range(max_iters), maxinterval=max_iters, desc="Training with Normal Attention")
for epoch in pbar:
